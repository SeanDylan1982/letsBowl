...
const username = path.split("/").pop().slice(0,-5);
...
appContainer.innerHTML = `
    ...
    <div class="main_resize">
        ...
        <!-- Main header ssection starts -->
            <div id="banner"> 
                <form action="../profile-images.php" method="POST" class="form-group" id="images-form" name="images-form">
                    <label for="banner-upload" name="banner-upload">
                    <div class="add-banner" id="add-banner-image">Upload a banner image <input type="file" id="banner-upload" name="banner-upload" accept="image/png" /> </div>
                    <img id="banner-img" src="../images/${username}-banner.png" alt="A custom banner image across the top of the page." style="width: 923px; height: 260px;"></label>
                    <label for="ppic" name="ppic">
                    <div class="add-ppic" id="add-ppic-image">Upload a profile pic <input type="file" id="ppic" name="ppic" accept="image/png" /> </div>
                    <img id="profile_pic" src="../images/${username}-ppic.png" alt="The profile owner's picture"></label>
                    <div id="username">@${username}</div>
                    <button type="submit" name="submit" value="submit" class="btn btn-success" id="save-images"> Save </button>
                </form>
...
`;
// document.getElementById("a").innerHTML = appContainer;
...
<div class="main_resize">
    ...
    <!-- Main header ssection starts -->
        <div id="banner">
            <form action="./profile-images.php" method="get" class="form-group" id="images-form" name="images-form">
                <label for="banner-upload" name="banner-upload">
                <div class="add-banner" id="add-banner-image">Upload a banner image <input type="file" id="banner-upload" name="banner-upload" accept="image/png" /> </div>
                <img id="banner-img" src="../images/default-banner.png" alt="A custom banner image across the top of the page." style="width: 923px; height: 340px;"></label>
                <label for="ppic" name="ppic">
                <div class="add-ppic" id="add-ppic-image">Upload a profile pic <input type="file" id="ppic" name="ppic" accept="image/png" /> </div>
                <img id="profile_pic" src="../images/default-user.png" alt="The profile owner's picture"></label>
